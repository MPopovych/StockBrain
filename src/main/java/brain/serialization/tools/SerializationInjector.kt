...
private fun defaultInjector(): Injector {
	...
	default.push(Activations.Sigmoid)
	default.push(Activations.SiLU)
	default.push(Activations.FT)
	default.push(Activations.LeakyReLu)
	default.push(Activations.Softmax)
	default.push(Activations.BinZP)
	...
	default.push(Activations.Sin)
	default.push(InputFactory)
	default.push(DenseFactory)
	default.push(SparseFactory)
	default.push(UnBiasedDenseFactory)
	default.push(ScaleFactory)
	default.push(ConcatFactory)
	default.push(AttentionFactory)
	default.push(AdditiveFactory)
	default.push(FlattenFactory)
	default.push(ActivationFactory)
	default.push(MaxPooling1DFactory)
	default.push(AvgPooling1DFactory)
	default.push(GlobalNormFactory)
	return default
}